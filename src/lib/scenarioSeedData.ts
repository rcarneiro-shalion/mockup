...
// records per store, pulled from backoffice-api /v1.0/admin/locations (2026-06-23).
// See locationsBulk.ts (in-bundle, never persisted).
export { REAL_LOCATION_SETS } from "./locationsBulk";
