...
export const DC_SPECS: Record<string, ApproxSpec> = {
  ...
  "dc-orders": {
    ...
    rows: [
      { id: "ord-ah-web-nl-content-pdp-eco2", name: "Albert Heijn Web NL - Content PDP - eco2 - Content 30", store: "Albert Heijn Web NL", project: "Albert Heijn Web GLOBAL - PDP", deliveryMethodType: "s3", inputsInstructionsType: "ecometrypdp", timeframe: "content 30d", scheduling: "55 3 * * ?", isActive: true, machineSize: "XXS", bucket: "prod-data-collector-dispatcher", folder: "ds_pdp", createdAt: "2024-04-02 12:15", updatedAt: "2026-07-13 14:47" },
      { id: "ord-glovo-es-odm-plp", name: "Glovo ES - ODM PLP (Quick Commerce & Restaurants)", store: "Glovo ES", project: "Glovo ES - ODM", deliveryMethodType: "s3", inputsInstructionsType: "ecometryplp", timeframe: "All Day (1 x day)", scheduling: "15 4 * * ?", isActive: true, machineSize: "M", bucket: "prod-data-collector-dispatcher", folder: "ds_plp", deliveryOutputsJson: '[{"conditionKey":"","method":"s3","attrs":{"bucket":"prod-data-collector-dispatcher","folder":"ds_plp"}},{"conditionKey":"quick_commerce","method":"s3","attrs":{"bucket":"prod-data-collector-dispatcher","folder":"ds_qcommerce"}},{"conditionKey":"restaurant","method":"firehose","attrs":{"streamName":"odm-restaurants-stream"}}]', createdAt: "2026-07-10 09:00", updatedAt: "2026-07-15 10:00" },
      { id: "ord-7eleven-th-daily-plp", name: "7 - Eleven APP TH - Daily PLP", store: "7 - Eleven APP TH", project: "7-Eleven APP TH - CompleteOffer", deliveryMethodType: "s3", inputsInstructionsType: "ecometryplp", timeframe: "All Day (1 x day)", scheduling: "32 5 * * ?", isActive: true, machineSize: "S", createdAt: "2025-08-19 18:40", updatedAt: "2025-08-19 18:40" },
      { id: "ord-7eleven-th-geoloc", name: "7 - Eleven APP TH - Geoloc PLP", store: "7 - Eleven APP TH", project: "7-Eleven APP TH - CompleteOffer", deliveryMethodType: "s3", inputsInstructionsType: "ecometryplp", timeframe: "geoloc", scheduling: "28 00 * * ?", isActive: true, machineSize: "S", createdAt: "2025-08-19 18:40", updatedAt: "2025-12-26 18:24" },
      { id: "ord-7eleven-th-media", name: "7 - Eleven APP TH - Media", store: "7 - Eleven APP TH", project: "7-Eleven APP TH - Media", deliveryMethodType: "s3", inputsInstructionsType: "ecometrymedia", timeframe: "media", scheduling: "32 6 * * ?", isActive: true, machineSize: "S", createdAt: "2025-08-20 11:26", updatedAt: "2025-08-20 11:26" },
      { id: "ord-abgr-ads", name: "AB-Delhaize GR - Ads", store: "AB GR", project: "AB-Delhaize GR - Ads", deliveryMethodType: "s3", inputsInstructionsType: "ecometryad", timeframe: "All Day (1 x day)", scheduling: "25 1 * * ?", isActive: true, machineSize: "S", createdAt: "2025-01-27 16:47", updatedAt: "2025-01-27 16:47" },
      { id: "ord-abgr-content-pdp", name: "AB-Delhaize GR - Content PDP", store: "AB GR", project: "AB GR - PDP", deliveryMethodType: "s3", inputsInstructionsType: "ecometrypdp", timeframe: "content 30d", scheduling: "57 1 * * ?", isActive: true, machineSize: "M", createdAt: "2025-01-28 16:09", updatedAt: "2026-07-13 14:47" },
      { id: "ord-abgr-daily-pdp", name: "AB-Delhaize GR - Daily PDP", store: "AB GR", project: "AB GR - PDP", deliveryMethodType: "s3", inputsInstructionsType: "ecometrypdp", timeframe: "All Day (1 x day)", scheduling: "43 10 * * ?", isActive: true, machineSize: "M", createdAt: "2025-01-28 16:09", updatedAt: "2025-06-08 19:01" },
      { id: "ord-abgr-daily-plp", name: "AB-Delhaize GR - Daily PLP", store: "AB GR", project: "AB-Delhaize GR & Delhaize BE - PLP", deliveryMethodType: "s3", inputsInstructionsType: "ecometryplp", timeframe: "All Day (1 x day)", scheduling: "30 1 * * ?", isActive: true, machineSize: "M", createdAt: "2025-01-27 16:54", updatedAt: "2025-01-27 16:54" },
      { id: "ord-abgr-daily-search", name: "AB-Delhaize GR - Daily Search", store: "AB GR", project: "AB-Delhaize GR & Delhaize BE - PLP", deliveryMethodType: "s3", inputsInstructionsType: "ecometrysearch", timeframe: "All Day (1 x day)", scheduling: "51 2 * * ?", isActive: true, machineSize: "M", createdAt: "2025-01-27 16:55", updatedAt: "2025-12-26 16:34" },
      { id: "ord-abgr-daily-shelf", name: "AB-Delhaize GR - Daily Shelf", store: "AB GR", project: "AB-Delhaize GR & Delhaize BE - PLP", deliveryMethodType: "s3", inputsInstructionsType: "ecometryshelf", timeframe: "All Day (1 x day)", scheduling: "24 1 * * ?", isActive: true, machineSize: "M", createdAt: "2025-01-27 16:55", updatedAt: "2025-12-26 16:28" },
      { id: "ord-ahorramas-ads", name: "Ahorramas ES - Ads", store: "Ahorramas ES", project: "Ahorramas ES - Ads", deliveryMethodType: "s3", inputsInstructionsType: "ecometryad", timeframe: "All Day (1 x day)", scheduling: "59 2 * * ?", isActive: true, machineSize: "S", createdAt: "2024-02-09 16:22", updatedAt: "2024-02-09 16:22" },
      { id: "ord-ahorramas-content-pdp", name: "Ahorramas ES - Content PDP", store: "Ahorramas ES", project: "Ahorramas ES - PDP", deliveryMethodType: "s3", inputsInstructionsType: "ecometrypdp", timeframe: "content 30d", scheduling: "38 7 * * ?", isActive: true, machineSize: "M", createdAt: "2024-04-02 12:40", updatedAt: "2026-07-13 14:47" },
      { id: "ord-ahorramas-daily-pdp", name: "Ahorramas ES - Daily PDP", store: "Ahorramas ES", project: "Ahorramas ES - PDP", deliveryMethodType: "s3", inputsInstructionsType: "ecometrypdp", timeframe: "All Day (1 x day)", scheduling: "13 3 * * ?", isActive: true, machineSize: "M", createdAt: "2024-02-29 10:07", updatedAt: "2024-04-19 14:41" },
      { id: "ord-ahorramas-daily-plp", name: "Ahorramas ES - Daily PLP", store: "Ahorramas ES", project: "Ahorramas ES - PLP", deliveryMethodType: "s3", inputsInstructionsType: "ecometryplp", timeframe: "All Day (1 x day)", scheduling: "4 1 * * ?", isActive: true, machineSize: "M", createdAt: "2024-04-02 12:29", updatedAt: "2025-12-26 16:26" },
      { id: "ord-ahorramas-geoloc", name: "Ahorramas ES - Geoloc", store: "Ahorramas ES", project: "Ahorramas ES - PLP", deliveryMethodType: "s3", inputsInstructionsType: "ecometryplp", timeframe: "geoloc", scheduling: "4 1 * * ?", isActive: true, machineSize: "M", createdAt: "2024-06-22 22:57", updatedAt: "2025-12-26 16:28" },
      { id: "ord-ah-app-nl-content-pdp", name: "Albert Heijn APP NL - Content PDP", store: "Albert Heijn APP NL", project: "Albert Heijn APP NL - PDP", deliveryMethodType: "firehose", inputsInstructionsType: "ecometrypdp", timeframe: "content 30d", scheduling: "32 3 * * ?", isActive: true, machineSize: "M", createdAt: "2024-04-02 12:15", updatedAt: "2026-07-13 14:47" },
      { id: "ord-ah-app-nl-daily-search", name: "Albert Heijn APP NL - Daily Search", store: "Albert Heijn APP NL", project: "Albert Heijn APP NL - PLP", deliveryMethodType: "firehose", inputsInstructionsType: "ecometrysearch", timeframe: "All Day (1 x day)", scheduling: "39 4 * * ?", isActive: true, machineSize: "M", createdAt: "2024-02-09 15:57", updatedAt: "2024-02-09 15:57" },
    ],
    fields: [
      { key: "name", label: "Name", type: "text", required: true },
      { key: "description", label: "Description", type: "textarea", required: false },
