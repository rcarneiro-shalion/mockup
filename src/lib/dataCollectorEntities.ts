...
export const DC_SPECS: Record<string, ApproxSpec> = {
  ...
  "dc-orders": {
    ...
    rows: [
      { id: "ord-amz-us-search-daily", name: "Amazon US Search — Daily", store: "Amazon US", project: "Amazon US — Search", deliveryMethodType: "Firehose", inputsInstructionsType: "SEARCH", timeframe: "Daily 06:00", scheduling: "0 6 * * ?", isActive: true, machineSize: "M", cacheValidity: 0, createdAt: "2025-09-12 09:35", updatedAt: "2026-05-28 14:20" },
      { id: "ord-walmart-pdp-weekly", name: "Walmart PDP — Weekly", store: "Walmart", project: "Walmart — PDP", deliveryMethodType: "S3", inputsInstructionsType: "PDP", timeframe: "Weekly Mon", scheduling: "0 5 ? * MON", isActive: true, machineSize: "L", cacheValidity: 3600, createdAt: "2025-10-02 11:50", updatedAt: "2026-06-01 10:25" },
      { id: "ord-carrefour-shelf-daily", name: "Carrefour Shelf — Daily", store: "Carrefour FR", project: "Carrefour FR — Shelf", deliveryMethodType: "Rabbitmq", inputsInstructionsType: "SHELF", timeframe: "Daily 04:00", scheduling: "0 4 * * ?", isActive: true, machineSize: "M", cacheValidity: 0, createdAt: "2025-08-21 08:20", updatedAt: "2026-04-19 16:55" },
      { id: "ord-tesco-ads-daily", name: "Tesco Ads — Daily", store: "Tesco", project: "Tesco — Sponsored Ads", deliveryMethodType: "S3", inputsInstructionsType: "AD", timeframe: "Daily 07:00", scheduling: "0 7 * * ?", isActive: true, machineSize: "S", cacheValidity: 0, createdAt: "2025-11-15 13:25", updatedAt: "2026-06-05 09:50" },
      { id: "ord-kroger-plp-weekly", name: "Kroger PLP — Weekly", store: "Kroger", project: "Kroger — PLP", deliveryMethodType: "Firehose", inputsInstructionsType: "PLP", timeframe: "Weekly Wed", scheduling: "0 5 ? * WED", isActive: false, machineSize: "L", cacheValidity: 86400, createdAt: "2025-07-30 10:10", updatedAt: "2026-02-28 11:35" },
      { id: "ord-amz-uk-media-daily", name: "Amazon UK Media — Daily", store: "Amazon UK", project: "Amazon UK — Media", deliveryMethodType: "S3", inputsInstructionsType: "MEDIA", timeframe: "Daily 08:00", scheduling: "0 8 * * ?", isActive: true, machineSize: "XL", cacheValidity: 0, createdAt: "2026-01-18 14:45", updatedAt: "2026-06-08 15:15" },
    ],
    fields: [
      { key: "name", label: "Name", type: "text", required: true },
      { key: "description", label: "Description", type: "textarea", required: false },
