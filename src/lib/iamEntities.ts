...
export const IAM_SPECS: Record<string, ApproxSpec> = {
  ...
  "iam-users": {
    ...
    columns: [
      ...
      { label: "Datagroups", key: "datagroups" },
      { label: "Role", key: "role" },
    ...
    rows: [
      { id: "usr-john-doe", email: "john.doe@example.com", accounts: "coca-cola.shalion, pepsi.shalion", datagroups: 3, role: "Analyst", status: "Active", creationDateTime: "2025-01-15 10:30:00", lastUpdatedDateTime: "2026-06-10 14:22:00" },
      { id: "usr-jane-smith", email: "jane.smith@company.com", accounts: "nestle.shalion", datagroups: 2, role: "Manager", status: "Active", creationDateTime: "2025-02-20 09:15:00", lastUpdatedDateTime: "2026-05-28 16:45:00" },
      { id: "usr-admin-shalion", email: "admin@shalion.com", accounts: "coca-cola.shalion, groupm.shalion, perfetti.shalion", datagroups: 6, role: "Admin", status: "Inactive", creationDateTime: "2024-12-01 08:00:00", lastUpdatedDateTime: "2026-06-05 11:30:00" },
      { id: "usr-maria-garcia", email: "maria.garcia@cocacola.com", accounts: "coca-cola.shalion", datagroups: 1, role: "Viewer", status: "Active", creationDateTime: "2025-03-12 13:05:00", lastUpdatedDateTime: "2026-06-08 10:12:00" },
      { id: "usr-tom-lee", email: "tom.lee@pepsico.com", accounts: "pepsi.shalion", datagroups: 2, role: "Analyst", status: "Active", creationDateTime: "2025-04-03 11:40:00", lastUpdatedDateTime: "2026-05-30 09:55:00" },
      { id: "usr-sara-kim", email: "sara.kim@shalion.com", accounts: "groupm.shalion, jde.shalion", datagroups: 3, role: "Read only", status: "Active", creationDateTime: "2025-05-21 15:20:00", lastUpdatedDateTime: "2026-06-09 17:30:00" },
    ],
    fields: [
